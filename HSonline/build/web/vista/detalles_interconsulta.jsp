...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/recursos/css/header.css">
    ...
    <body>
        ...
        <button type="button" onclick="window.print()" class="detalle-printbtn"><i class="fas fa-print" style="font-size: 24px"></i> Imprimir</button>
            ...
            <div id="detalle" class="detalle">
                ...
                <div class="detalle-content" >
                    <div class="detalle-header">
                        ...
                        <div class="historial">
                            <span><b>Consulta ID:</b> ${datos.get(1).getCodigo()} </span>
