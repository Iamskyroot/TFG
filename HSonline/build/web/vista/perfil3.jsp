                ...
                <div class="container-fluid">
                    ...
                    <div class="container-data">
                        ...
                        <div class="imgcontainer">
                            ...
                            <h3>${sanitario.getNombre()}</h3>
                            <button type="button" onclick="editarPerfil()" class="edit-btn">Editar</button>
                        </div>
                        <form action="actualizaperfilsanitario" method="post" class="form-container" onsubmit="return checkPassword()">
                            ...
                            <fieldset>
                                ...
                                <div class="f_row">
                                    <div class="f_column">
                                        <label>Nombre</label>
                                        <input type="text" id="nom" name="nombre" class="f_txt" value="${sanitario.getNombre()}" disabled="true">
                                    </div>
                                    <div class="f_column">
                                        <label>Sexo</label>
                                        <div class="f_txt">
                                ...
                                <div class="f_row">
                                    ...
                                    <div class="f_column">
                                        ...
                                        <input type="text" name="documento" id="doc" class="f_txt" value="${sanitario.getDocumento()}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="f_row">
                                    <div class="f_column">
                                        ...
                                        <select class="f_txt esp" name="espe">
                                            <option>${sanitario.getEspecialidad()}</option>
                            ...
                            <fieldset>
                                ...
                                <div class="f_row">
                                    <div class="f_column">
                                        ...
                                        <input type="text" id="dir" name="dir" class="f_txt" value="${sanitario.getDireccion()}" disabled="true">
                                    </div>
                                    <div class="f_column">
                                        <label>Telefono</label>
                                        <input type="text" id="tel" name="tel" class="f_txt" value="${sanitario.getTelefono()}" disabled="true">
                                    </div>
                                    <div class="f_column">
                                        <label>Email</label>
                                        <input type="email" id="email" name="email" class="f_txt" value="${sanitario.getEmail()}" disabled="true">
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset>
                                ...
                                <div class="f_row">
                                    <div class="f_column">
                                        <label>Usuario</label>
                                        <input type="text" name="user" id="user" class="f_txt" value="${sanitario.getUsuario()}" disabled="true">
                                    </div>
                                    <div class="f_column">
                                        <label>Contraseña</label>
                                        <input type="password" name="psw" id="passw" class="f_txt" value="${sanitario.getContrasena()}" disabled="true">
                                    </div>
                                    <div class="f_column">
                                        <label>Repita la contraseña</label>
                                        <input type="password" name="psw2" id="passw2" class="f_txt" value="${sanitario.getContrasena()}" disabled="true">
                                    </div>
                                </div>
