<%-- 
    Document   : login
    Created on : 22-may-2023, 20:02:33
    Author     : Skyroot
--%>
...
<html>
    <head>
        ...
        <title>Login</title>
        <link href="<%= request.getContextPath() %>/recursos/css/estilos_login.css" rel="stylesheet" type="text/css"/>
...
<!--        <div class="footer">
        ...
        <script src="<%= request.getContextPath() %>/recursos/js/login.js" type="text/javascript"></script>
    </body>
</html>
